    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e = ChannelException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i106 in range(_size102):
                        _elem107 = ChannelNotificationSetting()
                        _elem107.read(iprot)
...
class getFriendChannelMatrices_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i113 in range(_size109):
                        ...
                        self.channelIds.append(_elem114)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter115 in self.channelIds:
...
class issueRequestTokenWithAuthScheme_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i120 in range(_size116):
                        ...
                        self.authScheme.append(_elem121)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.authScheme is not None:
            ...
            for iter122 in self.authScheme:
...
class getUpdatedChannelIds_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i127 in range(_size123):
                        _elem128 = ChannelIdWithLastUpdated()
                        _elem128.read(iprot)
                        self.channelIds.append(_elem128)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter129 in self.channelIds:
                iter129.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i141 in range(_size137):
                        _elem142 = ChannelNotificationSetting()
                        _elem142.read(iprot)
                        self.setting.append(_elem142)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
